    ...
    public partial class m2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProducts", x => new { x.Id_Order, x.Id_Product });
                    table.ForeignKey(
                        name: "FK_OrderProducts_Orders_Id_Order",
                        column: x => x.Id_Order,
                        principalTable: "Orders",
                        principalColumn: "Id_Order",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProducts_Products_Id_Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_Id_Product",
                table: "OrderProducts",
                column: "Id_Product");
